...
from core.models import FieldGuideItem
from core.views import tarla_rehberi_detay_view
...
REHBER_DATA = {
    ...
    'yaprak-bitleri': {
        ...
        'case_scenario': 'Nisan ayında havaların aniden ısınmasıyla biber ve patlıcan yapraklarında hızlı sürgün gelişimi başlar. Bu dönemde rüzgarla gelen kanatlı yaprak bitleri, taze tepe sürgünlerine yerleşerek hızla ürer. Bitki özsuyunu emerek yaprakları kubbeleştirir. İlerleyen günlerde virüs taşıyan thripslerin de gelmesiyle tarlada mozaik virüsü salgını başlar ve verim %80 oranında düşer.',
    ...
    'yaprak-kulleme': {
        ...
        'case_scenario': 'Eylül ayında gündüzler ılık, geceler ise serin ve çiğli geçer. Havasız seralarda domates yapraklarının üstünde küçük beyaz toz lekeleri belirir. Birkaç gün içinde külleme mantarı tüm yaprak yüzeylerini örter. Yapraklar fotosentez yapamadığı için meyve büyümesi durur, bitki zayıflar ve hasat sezonu erken kapanır.',
        'organic_recipe_name': 'Kükürt ve Süt Antifungal Çözeltisi',
        'organic_recipe_prep': '1 litre yağlı çiğ süt, 9 litre klorsuz su ile karıştırılır. Fungal direnci artırmak için içerisine 30 gram ıslanabilir kükürt (Wettable Sulphur) eklenir.',
    ...
    'radyasyon-donu': {
        ...
        'favorable_conditions': 'Bulutsuz, rüzgarsız kış geceleri, 0°C ve altındaki ani sıcaklık düşüşleri.',
