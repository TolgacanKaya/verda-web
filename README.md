...
### 🧪 1. Interactive Laboratory & Phytotherapy Panel
...
* **Printable Diagnostic Certificate (`@media print`)**: One-click generation of clean, print-optimized diagnostic reports devoid of navigation UI.

### 💻 2. Django REST API Gateway
...
* **Frontend Technologies**: HTML5, Vanilla CSS3 (Custom Glassmorphism design), Modern JavaScript (ES6+)
...
├── core/                      # Laboratory simulator & home portal views
