...
# Django ortamını başlatmak için ana dizini ekle
...
def generate_mock_image(plant_name):
    try:
        ...
        draw.text((400, 450), plant_name, fill=(20, 20, 20), anchor="mm", font=font)
        draw.text((400, 500), "AI Ziraat Premium Kütüphanesi", fill=(60, 60, 60), anchor="mm", font=font)
